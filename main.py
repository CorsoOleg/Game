...
player_rect.midleft = main_display.get_rect().midleft
# player_speed = [1, 1] 
...
def creat_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH, random.randint(0, 900), *enemy_size)
...
def creat_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(300, 600), 0, *bonus_size)
